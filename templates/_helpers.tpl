...
helm.sh/chart: {{ include "charttest1.chart" . }}
{{ include "charttest1.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "charttest1.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "charttest1.fullname" .) .Values.serviceAccount.name }}
{{- else }}
